...
send HTTP requests to the device. The `@rci-tools/base` module providers
...
import {RciQuery, RciManager, SessionManager, FetchTransport} from '@rci-tools/base';
