...
Он предоставляет возможность напрямую взаимодействовать с RCI API или запустить
...
- SSH-доступ к целевому устройству
- Для SSH по паролю: установленная утилита `sshpass`
