...
2. `npm` packages that can be used to interact with that API ([`npm` Packages](#2-npm-packages))
3. Example applications created using those `npm` packages ([Example apps](#3-example-apps))
...
Then follow the steps described in the README file of the application
you want to run.
...
> for using SSH access to the device.
>
...
> [sshpass-win32](https://github.com/xhcoding/sshpass-win32) or use WSL.
>
